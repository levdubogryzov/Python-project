...
============================================================
ДЕТАЛИЗАЦИЯ ВЫЗОВОВ (TOP 20 CUMULATIVE TIME)
============================================================
...
============================================================
Анализ объектов: Размер одного AlgorithmEvent ~80 bytes
Использование генераторов обеспечивает сложность по памяти O(1)
============================================================
